...
// Fetch sales records where amount_owed > 0
$sales = [];
try {
    $query = "SELECT * FROM sales WHERE amount_owed > 0  ORDER BY created_at DESC"; 
        ...
        <div class="main-panel">
          ...
          <?php
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2">Customer Debts </h2>
